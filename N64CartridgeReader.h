...
#define _MASS_STORAGE_H_
	...
	/* Macros: */
        ...
        /** Total number of logical drives within the device - must be
         * non-zero.
         */
		#define TOTAL_LUNS                1

        /** Blocks in each LUN, calculated from the total capacity divided by
         * the total number of Logical Units in the device.
         */
